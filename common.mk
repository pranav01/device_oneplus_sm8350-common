...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/permissions/oplus_camera_default_grant_permissions_list.xml:$(TARGET_COPY_OUT_PRODUCT)/etc/permissions/oplus_camera_default_grant_permissions_list.xml \
